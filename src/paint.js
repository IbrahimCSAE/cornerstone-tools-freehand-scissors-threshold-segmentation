...
const isPointInPolygon = cornerstoneTools.import("util/isPointInPolygon");
const triggerEvent = cornerstoneTools.import("util/triggerEvent");
const getLogger = cornerstoneTools.import("util/getLogger");
const logger = getLogger(
  "util:segmentation:operations:paintWithinThresholdInsideOrOutsideFreehandShape"
);
 ...
 *                          modify, the `segmentIndex`, the `points` array and tool configuration.
 * @returns {null}
 */
 ...
 * @param {Function} pointInShape A function that returns true if the point is in the shape.
